import{vk as X,FA as Z,FB as ee,Ed as te,Eb as ie,FC as re,FD as ae,Ei as o,Ft as se,ER as oe,Fs as ne,Eh as w,FE as ce,FF as le,Ee as pe,Eg as de,Ej as he,Fc as ve,El as ue,FG as A,FH as N,FI as me,FJ as fe,EV as ge,fY as Se,Em as Pe,En as ye,_ as _e,Eo as C,Ep as R,Eq as we,Er as U,Es as W,EX as ze,Eu as xe,Ev as $e,Ew as be,Ey as V,Ez as Te,FK as Ve,FL as I,FM as B,FN as ke,FO as Oe,FP as De,EA as Ee,n as p,EB as d,fV as Fe,EY as Ce,FQ as q,qt as We,Fk as Le,kL as Me,EG as je,cj as Y,xb as Ae,gu as G,cu as H,FR as Ne}from"./index-JOCrQyYq.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
